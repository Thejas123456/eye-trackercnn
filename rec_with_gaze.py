...
def detect_red_boxes_with_white(image, gaze_x, gaze_y):
    ...
    # Check if gaze is on a red box and perform OCR
    for box in red_boxes:
            x, y, w, h = box
            cv2.rectangle(image, (x, y), (x + w, y + h), (0, 255, 0), 2)
            # If gaze point is inside the bounding box
    ...
    try:
        ...
        if ID == 1:
           ...
           # Preprocess the image for model input
            ...
            detect_red_boxes_with_white(frames2,xcenter,ycenter)
